...
import com.duonghv.cm.crud.entities.Review;
import com.duonghv.cm.crud.repos.ReviewRepository;
...
public class ReviewController {
    ...
    public Review publishedUpdate(@PathVariable int id, @PathVariable boolean value) {
        Review review = repo.findById(id).orElseThrow(NotFoundException::new);
