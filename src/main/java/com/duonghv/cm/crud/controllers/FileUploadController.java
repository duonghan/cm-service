...
import com.duonghv.cm.crud.entities.UploadFile;
import com.duonghv.cm.crud.repos.FileRepository;
...
public class FileUploadController {
    ...
    public ResponseEntity<InputStreamResource> getFile(@PathVariable int id )
            throws IOException {
        File file = new File( context.getRealPath(repo.findById(id).orElseThrow(IOException::new).diskPath));
